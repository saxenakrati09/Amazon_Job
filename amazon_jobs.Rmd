...
p17 <- ggplot(data = filter(counts, counts$Experience != 0), aes(Positions, Freq)) +
      geom_bar(aes(fill = Experience), position = "dodge",stat = "identity") +
      ggtitle("Positions distribution based on Experience") 
p18 <- ggplot(data = filter(counts, counts$Experience == 0), aes(Positions, Freq)) +
      geom_bar(aes(fill = Experience), position = "dodge",stat = "identity") +
      ggtitle("Positions where Experience is not defined") 
multiplot(p17, p18)
...
p19 <- ggplot(data = filter(counts, counts$Experience != 0), aes(Domain, Freq)) +
      geom_bar(aes(fill = Experience), position = "dodge",stat = "identity") +
      ggtitle("Domain distribution based on Experience") 

p20 <- ggplot(data = filter(counts, counts$Experience == 0), aes(Domain, Freq)) +
      geom_bar(aes(fill = Experience), position = "dodge",stat = "identity") +
      ggtitle("Domain where Experience is not defined") 
multiplot(p19, p20)
```
